    ...
    return (React.createElement(StyledAlert, null,
        ...
        onClick && (React.createElement(CloseHandler, null,
            React.createElement(IconButton, { size: "sm", variant: "text", onClick: onClick },
                React.createElement(Icon$R, { width: "24px", color: "currentColor" }))))));
};
...
var DefaultSeparator = React.createElement(Icon$T, { color: "currentColor", width: "24px" });
...
var LinkExternal = function (_a) {
    ...
    return (React.createElement(Link, __assign({ external: true }, props),
        children,
        React.createElement(Icon$I, { color: "primary", ml: "4px" })));
};
...
var Logo$1 = function (_a) {
    ...
    return (React.createElement(Svg, __assign({ viewBox: "0 0 205 26" }, props),
        React.createElement("image", { width: "205", height: "26", href: isDark ? "/images/apwars/LogoTextNewDark.png" : "/images/apwars/LogoTextNewWhite.png" })));
};
...
var Logo = function (_a) {
    ...
    var innerLogo = (React.createElement(React.Fragment, null,
        React.createElement(Icon$L, { className: "mobile-icon" }),
    ...
    return (React.createElement(Flex, null,
        ...
        isAbsoluteUrl ? (React.createElement(StyledLink, { as: "a", href: href, "aria-label": "APWars Home Page" }, innerLogo)) : (React.createElement(StyledLink, { to: href, "aria-label": "APWars Home Page" }, innerLogo))));
};
var templateObject_1$c;
...
var links = [
    ...
    },
    {
        ...
        items: [
            ...
            {
                label: "Docs",
                href: "https://apwars.gitbook.io/apwars-farm/",
            },
            {
                label: "Blog",
...
var Accordion = function (_a) {
    ...
    return (React.createElement(Container$2, null,
        React.createElement(MenuEntry, { onClick: handleClick, className: className },
            ...
            isOpen ? React.createElement(Icon$11, null) : React.createElement(Icon$12, null)),
    ...
    return (React.createElement(Container, null,
        React.createElement(SocialEntry, null,
            cakePriceUsd ? (React.createElement(PriceLink, { href: priceLink, target: "_blank" },
                React.createElement(Icon$G, { width: "24px", mr: "8px" }),
...
var ConnectModal = function (_a) {
    ...
    return (React.createElement(Modal, { title: "Connect to a wallet", onDismiss: onDismiss },
        ...
        React.createElement(HelpLink, { href: "https://docs.pancakeswap.finance/guides/faq#how-do-i-set-up-my-wallet-on-binance-smart-chain", external: true },
            React.createElement(Icon$N, { color: "primary", mr: "6px" }),
...
export { Icon$15 as AddIcon, Alert, Icon$14 as ArrowBackIcon, Icon$13 as ArrowDownIcon, Icon$12 as ArrowDropDownIcon, Icon$11 as ArrowDropUpIcon, Icon$10 as ArrowForwardIcon, Icon$$ as AutoRenewIcon, BackgroundImage, GridLayout$1 as BaseLayout, Icon$_ as BinanceIcon, Icon$17 as BlockIcon, Breadcrumbs, Icon$Z as BunnyPlaceholderIcon, Button, ButtonMenu, ButtonMenuItem, Icon$X as CalculateIcon, Card, CardBody, CardFooter, CardHeader, CardRibbon, Icon$Y as CardViewIcon, GridLayout as CardsLayout, Checkbox, Icon$19 as CheckmarkCircleIcon, Icon$W as CheckmarkIcon, Icon$V as ChevronDownIcon, Icon$U as ChevronLeftIcon, Icon$T as ChevronRightIcon, Icon$S as ChevronUpIcon, Icon$R as CloseIcon, Icon$Q as CogIcon, Icon$P as CommunityIcon, Icon$O as CopyIcon, CopyToClipboard, Dropdown, Icon$18 as ErrorIcon, Flex, Icon$F as GooseRoundIcon, Heading, Icon$N as HelpIcon, IconButton, Image, Icon$16 as InfoIcon, Input$1 as Input, Link, LinkExternal, Icon$M as ListViewIcon, Icon$L as LogoIcon, Icon$K as LogoRoundIcon, Menu, Icon$J as MinusIcon, Modal, ModalProvider, Icon$I as OpenNewIcon, Icon$G as PancakeRoundIcon, Icon$H as PancakesIcon, Icon$E as PrizeIcon, Progress, Icon$B as ProgressBunny, Radio, Icon$D as RemoveIcon, ResetCSS, Icon$x as SearchIcon, Skeleton, Spinner, Svg, Icon$w as SwapVertIcon, Icon$v as SyncAltIcon, Tag, Text, Icon$z as Ticket, Icon$y as TicketRound, ToastContainer, Toggle, Icon$C as VerifiedIcon, Icon$u as WarningIcon, Icon$A as Won, variants as alertVariants, byTextAscending, byTextDescending, darkTheme as dark, darkColors, lightTheme as light, lightColors, makeRender, links as menuConfig, types as toastTypes, useMatchBreakpoints, useModal, useParticleBurst, useTable, useWalletModal };
